...
<header class=" sticky-top bg-white">
    <div class="container-xl">
      <nav class="navbar navbar-expand-lg ">
        <a class="navbar-brand" href="index.php"><img class="img-fluid" src="assets/images/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active-blue" aria-current="page" href="index.php">Home</a>
            </li>
            <li class="nav-item">
            ...
            <li>
              <a href="">
                <button type="button" class="btn ms-3 secondary-solid-btn">get free proposal</button>
              </a>
            </li>
          </ul>
